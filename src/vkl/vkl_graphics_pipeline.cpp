...
VklGraphicsPipeline::VklGraphicsPipeline(VklDevice &device, const std::string &vertFilepath,
...
void VklGraphicsPipeline::createGraphicsPipeline(const std::string &vertFilepath, const std::string &fragFilepath,

...
//VklGraphicsPipeline<VertexType>::VklGraphicsPipeline(VklDevice &device, const std::string &vertFilepath,
...
//
//template<VklVertexType VertexType>
//VklGraphicsPipeline<VertexType>::~VklGraphicsPipeline() {
...
//
//template<VklVertexType VertexType>
//std::vector<char> VklGraphicsPipeline<VertexType>::readFile(const std::string &filepath) {
...
//
//template<VklVertexType VertexType>
//void VklGraphicsPipeline<VertexType>::createGraphicsPipeline(const std::string &vertFilepath, const std::string &fragFilepath,
...
//
//template<VklVertexType VertexType>
//void VklGraphicsPipeline<VertexType>::createShaderModule(const std::vector<char> &code, VkShaderModule *shaderModule) {

...
class VklScene {
  ...
  public:
    VklScene(VklDevice &device, glm::vec3 camera_pos, glm::vec3 camera_up)
        ...
        Material gray{MaterialType::Lambertian, 0.1, 0.1, 1.0, glm::vec3(0.3f, 0.3f, 0.3f)};
        Material red{MaterialType::Lambertian, 0.1, 0.1, 1.0, glm::vec3(0.9f, 0.1f, 0.1f)};
        Material green{MaterialType::Lambertian, 0.1, 0.1, 1.0, glm::vec3(0.1f, 0.9f, 0.1f)};

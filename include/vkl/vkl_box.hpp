...
public:
    ...
    void apply_transform(glm::mat4 trans) {
        ...
        std::vector<glm::vec3> points = {
            min_position + glm::vec3 {dx, dy, dz},
            min_position + glm::vec3 {dx, dy, 0},
            min_position + glm::vec3 {dx, 0, dz},
            min_position + glm::vec3 {dx, 0, 0},
            min_position + glm::vec3 {0, dy, dz},
            min_position + glm::vec3 {0, dy, 0},
            min_position + glm::vec3 {0, 0, dz},
            min_position + glm::vec3 {0, 0, 0},
        };
